...
<section id="container" class="">
	<header class="header dark-bg">
		...
		<!--logo start-->
		<a href="gunsmithIndex.jsp" class="logo">Gunsmith <span
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-laptop"></i>History Report</li>
					</ol>
				</div>
			</div>
							...
							<form class="form-inline" action="historyAction" role="form"
								...
								<div class="form-group">
									<input class="form-control" id="indateym" name="searchDate"
										type="text" size="18" placeholder="请选择查询日期" readonly>
								</div>
...
<script type="text/javascript">
	jeDate({
		dateCell : "#indateym",//isinitVal:true,
		format : "YYYY-MM",
