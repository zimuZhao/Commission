...
<body>
	...
	<section id="container" class="">
		...
		<aside>
			...
			<ul class="sidebar-menu">
				...
				<li class="active"><a class="" href="userHistoryReport.action">
				...
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="icon_menu-circle_alt"></i>Sales History Report
						</h3>
					</div>
					...
					<div class="col-md-4 col-md-offset-8 col-xs-12 m-b-20">
						<span>Please enter the query time :</span> <input
							...
							type="text" name="date-range-picker">
					</div>
	...
	<script src="${path}/js/jquery.table.js"></script>
	<script src="${path}/js/custom/hint.js"></script>
	<script src="${path}/js/custom/Validform.js"></script>
	<script src="${path}/js/custom/salesHistoryReport.js"></script>
