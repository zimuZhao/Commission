...
<body>
				...
				<ul class="nav pull-right top-menu">
					...
					<li class="dropdown"><a data-toggle="dropdown"
						...
						<ul class="dropdown-menu extended logout">
							...
							<li><a href="logoutAction.action"><i
									class="icon_clock_alt"></i> Log Out</a></li>
						</ul></li>
		...
		<aside>
			<div id="sidebar" class="nav-collapse">
				...
				<ul class="sidebar-menu">
					<li class="sub-menu"><a class="" href="userInfoBrief.action">
							<i class="icon_house_alt"></i> <span>Home</span>
					</a></li>

					<li class="sub-menu"><a class=""
						href="userHistoryReport.action"> <i class="icon_documents_alt"></i>
							<span>History Report</span>
					</a></li>

					<li class="active"><a class="" href="userCommission.action">
		...
		<section id="main-content">
			<section class="wrapper">
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="icon_menu-circle_alt"></i>Commission Report
						</h3>
					</div>

					<div class="col-md-4 col-md-offset-8 col-xs-12 m-b-20">
						<span>Please enter the query time :</span> <input
							id="date-range-picker" class="pull-right form-control"
							type="text" name="daterange" value="16/10/2016 - 17/10/2016">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-sm-4">
						<section class="panel">
							<header class="panel-heading"> Sales Proportion </header>
	...
	<script src="${path}/js/custom/hint.js"></script>
	<script src="${path}/js/custom/Validform.js"></script>
	<script src="${path}/js/custom/salesCommission.js"></script>
