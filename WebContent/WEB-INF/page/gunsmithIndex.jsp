...
<section id="container" class="">
	...
	<header class="header dark-bg">
		...
		<!--logo start-->
		<a href="index.html" class="logo">Gunsmith <span class="lite">A
				dmin</span></a>
		<!--logo end-->
			...
			<ul class="nav pull-right top-menu">
				...
				<li class="dropdown"><a data-toggle="dropdown"
					...
					<ul class="dropdown-menu extended logout">
						...
						<li class="eborder-top"><a href="myProfile.jsp"><i
								class="icon_profile"></i> My Profile</a></li>
						<li><a href="resetPassword.jsp"><i class="icon_key_alt"></i>
								Reset Password</a></li>
	...
	<aside>
		<div id="sidebar" class="nav-collapse ">
			...
			<ul class="sidebar-menu">
				<li class="active"><a class="" href="gunsmithIndex.jsp"> <i
						class="icon_house_alt"></i> <span>Admin Index Page</span>
				</a></li>
				<li class="sub-menu"><a class="" href="commissionAction.action">
						<i class="icon_document_alt"></i> <span>Monthly Report</span>
				</a></li>
				<li class="sub-menu"><a class=""
					href="bossHistoryReport.action"> <i class="icon_document_alt"></i>
			...
			<div class="row">
					...
					<div class="info-box blue-bg">
						...
						<div class="col-sm-7">
							<div class="count" data-toggle="tooltip"
								title="Locks price Today">Price</div>
							<div class="title" data-toggle="tooltip"
								title="Locks sales amount Today">num</div>
						</div>
					</div>
				</div>
				<!--/.col-->
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="info-box brown-bg">
						...
						<div class="col-sm-7">
							<div class="count" data-toggle="tooltip"
								title="Stocks prize Today">Price</div>
							<div class="title" data-toggle="tooltip"
								title="Stocks sales amount Today">num</div>
						</div>
					</div>
					<!--/.info-box-->
				</div>
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="info-box dark-bg">
						...
						<div class="col-sm-7">
							<div class="count" data-toggle="tooltip"
								title="Barrels prize Today">Price</div>
							<div class="title" data-toggle="tooltip"
								title="Barrels sales amount Today">num</div>
						</div>
					</div>
					<!--/.info-box-->
				</div>
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="info-box green-bg">
						<div class="row">
							...
							<div class="col-sm-6 today-title" data-toggle="tooltip"
								title="Total prize today">Price</div>
						</div>

						<div class="today-title" data-toggle="tooltip"
							title="Total prize LastWeek">LastWeek:Price</div>
						<div class="today-title" data-toggle="tooltip"
							title="Total prize LastWeek">LastMonth:Price</div>
					</div>
					<!--/.info-box-->
				</div>
				<!--/.col-->
...
<script>
	...
	function getSalesAreaLastMonth() {
		...
		barChart.setOption({
			...
			xAxis : [ {
				type : 'category',
				data : [ 'town1', 'town2', 'town3', 'town4', 'town5', 'town6',
						'town7', 'town8', 'town9', 'town10' ],
				axisTick : {
					alignWithLabel : true
				}
			} ],
