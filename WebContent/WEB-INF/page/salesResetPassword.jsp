...
<body>
							...
							<div class="panel-body">
								<form id="form" class="form-horizontal" method="post">
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="password" id="oldpassword" type="text"
												class="form-control" datatype="*"
												nullmsg="Please input old password!">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="password" id="newpassword" type="text"
												class="form-control" datatype="*6-16"
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="password" id="newpassword2" type="text"
												class="form-control" datatype="*6-16"
												nullmsg="Please confirm new password!">
										</div>
									</div>
	...
	<script src="${path}/js/custom/salesResetPassword.js"></script>
