...
<body>
		...
		<section id="main-content">
			<section class="wrapper">
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class=" icon_menu-circle_alt"></i> My Profile
						</h3>
						<ol class="breadcrumb">
							<li><i class="icon_house_alt"></i><a
								href="salesmanIndex.html">Home</a></li>
				...
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading"> Profile Info </header>
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" id='name' name='name'
												datatype="*1-20" nullmsg="Please input name!"
												value="${sessionScope.user.name}">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label">Linkman<span
											class="error">*</span></label>

										<div class="col-sm-6">
											<input type="text" class="form-control" id='linkman'
												name='linkman' datatype="*" nullmsg="Please input linkman!"
												value="${sessionScope.user.linkman}">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" id='email'
												name='email' datatype="e" nullmsg="Please input Email!"
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" id='mobile'
												name='mobile' datatype="*" nullmsg="Please input mobile!"
	...
	<script src="${path}/js/custom/salesMyProfile.js"></script>
